 ...
 */
@WebServlet("/AddFriendb")
public class AddFriendDb extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			WebResource webResource = client.resource("http://localhost:8080/RestService/addfriend/addfriend");
			MultivaluedMap formData1 = new MultivaluedMapImpl();
			formData1.add("friend", friend);
...
*/
			...
			RequestDispatcher rd=request.getRequestDispatcher("showFriend");
