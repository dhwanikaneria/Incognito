...
public class AddFriendController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			WebResource webResource = client.resource("http://localhost:8080/RestService/getUserService/searchUser");
			...
			if(restResponse.getStatus()==200)
			{
				...
				RequestDispatcher rd=request.getRequestDispatcher("AddFriend.jsp");
