...
@Path("/insertAndDeleteProductsService")
public class InsertAndDeleteProductsService {
	@Path("/insertProduct")
	@POST
	...
	public Response insertProduct(MultivaluedMap<String, String> formParam) {
		...
		try {
			...
			WebResource webResource = client.resource("http://localhost:8080/RestMicroServices/addAndDeleteProductDetailsMicroService/insertProductDetails");
